...
from .actor_critic_pd_learner_continuous import ActorCriticPDLearnerContinuous
...
REGISTRY["actor_critic_pd_learner_continuous"] = ActorCriticPDLearnerContinuous